      ...
      <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-6 items-start">
        ...
        <div className="space-y-5">
          ...
          <Section id="leave" title="4. Requesting Leave">
            ...
            <Bullets items={[
              <><strong>2. Pick your days and hours.</strong> <strong>Each day is its own request</strong> with its own hours — that way a half day (4 hours) one day and another half day the next works, and approvers approve or deny, and you can cancel, one day at a time. The form starts with today at 8 hours (a full day): change the date, and click <strong>+ Add another day</strong> for each additional day (it suggests the next workday). Weekends and scheduled holidays can&apos;t take leave. No day can hold more than 8 hours of leave in total — counting every pending and approved request of any type — so the form blocks Submit if a day would go over. Planned leave (PTO, Vacation, Bereavement, Jury Duty) can be booked as far ahead as you like — <strong>Sick leave</strong> can only be for today or earlier. You can also enter dates up to <strong>14 days back</strong> to catch up. All the days you add are submitted together and share one note and signature; your approvers get a single alert listing them.</>,
