      ...
      <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-6 items-start">
        ...
        <div className="space-y-5">
          ...
          <Section id="leave" title="4. Requesting Leave">
            ...
            <Bullets items={[
              <><strong>2. Pick your dates and hours.</strong> The form starts on today as a single day (From and To match) — change <strong>From</strong> to your date, and pick a later <strong>To</strong> only if the leave spans more days. For a half day, enter 4 hours; to split time across days or leave types, submit a separate request for each day. Then type in total hours or click <strong>Auto-fill</strong> (it skips weekends and scheduled holidays). 8 hours = 1 full day, and no day can hold more than 8 hours of leave in total — counting every pending and approved request of any type — so the form blocks Submit if your dates overlap leave you already have. Planned leave (PTO, Vacation, Bereavement, Jury Duty) can be booked as far ahead as you like — <strong>Sick leave</strong> can only be for today or earlier. You can also enter dates up to <strong>14 days back</strong> to catch up.</>,
