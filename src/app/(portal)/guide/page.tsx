        ...
        <div className="space-y-5">
          ...
          <Section id="timesheet" title="3. Logging Your Time (Timesheet)">
            ...
            <Bullets items={[
              ...
              <>The <strong>Tags</strong> column flags each day automatically — hover a tag for detail: <strong>Holiday</strong>, <strong>Holiday worked</strong> (hours logged on a holiday), the type of leave taken (<strong>PTO</strong>, <strong>Sick</strong>, <strong>Vacation</strong>…), <strong>Incomplete</strong> (no hours), <strong>Over 8 hrs</strong>, <strong>Short day</strong> (full-time staff under 8 hours with no leave), and <strong>Overtime</strong> (regular hours past 40 in a week). Next to the pay period you may also see tags for the whole timesheet, such as <strong>Reopened</strong>, <strong>Correction requested</strong>, <strong>Leave added late</strong>, <strong>Closed by accounting</strong>, or <strong>Payroll locked</strong>. Those automatic tags follow your hours and can&apos;t be edited. You can also add your own from the company&apos;s tag list — click <strong>+ Tag</strong> on a day and choose one (for example a grant or program); click the × on a tag to remove it. Your own tags save with the rest of the timesheet and can be changed until you submit. Everything appears in the CSV export and in what your approver sees.</>,
            ]} />
