      ...
      <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-6 items-start">
        ...
        <div className="space-y-5">
          ...
          <Section id="leave" title="4. Procedure — Leave Requests">
            ...
            <Numbered items={[
              <>Leave should be requested through the portal <strong>as it happens</strong> — in advance where possible, otherwise the same day (illness) — so timesheets stay current. Dates up to <strong>14 days in the past</strong> can be entered to catch up (through 10-08-2026, entries back to 09-13-2026 are accepted so the current pay period can be brought up to date); earlier dates are not accepted in the portal and must go through the Accounting Manager. Once accounting closes out a pay period, no further changes or requests are made for it.</>,
