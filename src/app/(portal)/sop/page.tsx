        ...
        <div className="space-y-5">
          ...
          <Section id="time-entry" title="3. Procedure — Time Entry">
            <Numbered items={[
              ...
              <><strong className="text-[#0b2b35]">Daily entry.</strong> Enter hours worked each day under Regular, and any time off under Leave. Hourly employees enter Regular hours directly; salaried employees&apos; Regular hours are system-calculated as 8 minus Leave hours for each day — only Leave needs to be entered.</>,
